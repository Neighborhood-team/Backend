...
@Getter
@Data
public class ResultResponseMemberDto {
    ...
    Long typeNumber;
    @Schema(description = "결과를 참가한 사용자 이름", example = "강따운")
    String memberName;

    public ResultResponseMemberDto(Result result) {
        ...
        this.memberName = result.getMember().getName();
    }
}